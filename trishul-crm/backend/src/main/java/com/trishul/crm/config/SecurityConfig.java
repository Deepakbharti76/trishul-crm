...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Explicit production origin + Vercel preview-deployment pattern
        // (Vercel gives every branch/PR its own *.vercel.app subdomain).
        // A bare "*" is deliberately NOT used here: browsers refuse to
        // honor Set-Cookie on a credentialed cross-origin response unless
        // Access-Control-Allow-Origin echoes back one specific, real origin.
